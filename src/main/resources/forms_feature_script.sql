...
CREATE TABLE hmanager.hm_form (
  "id"       BIGSERIAL NOT NULL PRIMARY KEY,
  "owner_id" BIGINT REFERENCES hmanager.hm_user,
  "name"     TEXT      NOT NULL
);

CREATE TABLE hmanager.hm_form_field (
  "id"                   BIGSERIAL NOT NULL PRIMARY KEY,
  "form_id"              BIGINT REFERENCES hmanager.hm_form,
  "form_field_type_id"   BIGINT REFERENCES hmanager.hm_form_field_type,
  "name"                 TEXT      NOT NULL,
  "is_required"          BOOLEAN,
  "is_editable"          BOOLEAN,
  "label"                TEXT,
...
CREATE TABLE hmanager.hm_form_available_values (
  "id"            BIGSERIAL NOT NULL PRIMARY KEY,
  "form_field_id" BIGINT REFERENCES hmanager.hm_form_field,
  "value"         TEXT,
  "name"          TEXT
);
...
CREATE TABLE hmanager.hm_medical_checkups (
  ...
  "created_by_id"      BIGINT REFERENCES hmanager.hm_user,
  "created_date"       DATE,
...
CREATE TABLE hmanager.hm_medical_checkups_values (
  "id"                 BIGSERIAL NOT NULL PRIMARY KEY,
  "medical_checkup_id" BIGINT REFERENCES hmanager.hm_medical_checkups,
  "form_field_id"      BIGINT REFERENCES hmanager.hm_form_field,
  "value"              TEXT
);
