...
public interface IMedicalHistoryService {
    ...
    MedicalHistoryDTO saveOrUpdate(Long patientId, MedicalHistoryDTO medicalHistoryDTO, boolean b) throws NoSuchElementExistsException, DataIntegrityException;
}
